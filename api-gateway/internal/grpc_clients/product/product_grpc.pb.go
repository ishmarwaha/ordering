...
const (
	...
	ProductService_DeductProductQuantity_FullMethodName = "/product.ProductService/DeductProductQuantity"
)
...
type ProductServiceClient interface {
	...
	// and deducts thems
	DeductProductQuantity(ctx context.Context, in *DeductQuantityRequest, opts ...grpc.CallOption) (*DeductQuantityResponse, error)
}
...
func (c *productServiceClient) DeductProductQuantity(ctx context.Context, in *DeductQuantityRequest, opts ...grpc.CallOption) (*DeductQuantityResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeductQuantityResponse)
	err := c.cc.Invoke(ctx, ProductService_DeductProductQuantity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductServiceServer interface {
	...
	// Checks if the requested product quantites are available
	// and deducts thems
	DeductProductQuantity(context.Context, *DeductQuantityRequest) (*DeductQuantityResponse, error)
...
func (UnimplementedProductServiceServer) DeductProductQuantity(context.Context, *DeductQuantityRequest) (*DeductQuantityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeductProductQuantity not implemented")
}
...
func _ProductService_DeductProductQuantity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeductQuantityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).DeductProductQuantity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_DeductProductQuantity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).DeductProductQuantity(ctx, req.(*DeductQuantityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeductProductQuantity",
			Handler:    _ProductService_DeductProductQuantity_Handler,
		},
	},
